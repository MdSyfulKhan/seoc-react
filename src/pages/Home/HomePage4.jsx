...
import HeroStyle4 from "../../components/sections/hero/HeroStyle4";
...
const heroData = {
  title:
    "Local SEO Tactics To <span> Dominate <img src='assets/img/elements/line-img1.png' alt='' /> </span> Your Market",
  subTitle: "Top #1 SEO &amp; Marketing Agency",
  desc: "Welcome to SEOC where we specialize in revolutionizing your online <br className='d-lg-block d-none' /> presence through expert SEO and digital marketing solutions.",
  btnText: "Analyze Now",
};
...
const HomePage4 = () => {
  return (
    <>
      <HeroStyle4 data={heroData} btnClass="header-btn12" />
      <AboutStyle4 data={aboutData} btnClass="header-btn12" />
      <ServiceStyle5 data={serviceData} btnClass="header-btn12" />
      <CaseStyle2 data={caseData} btnClass="header-btn12" />
      <WorkStyle5 data={workData} btnClass="header-btn12" />
      <PricingStyle1 data={pricingData} btnClass="header-btn12" />
      <TestimonialStyle4 data={testimonialData} />
      <BlogStyle4 data={blogData} />
      <CtaStyle4 data={ctaData} btnClass="header-btn12" />
    </>
  );
};
